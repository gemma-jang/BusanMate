// 1. Language Toggle Function (헤더 아이콘용)
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // MATE 데이터베이스 (한국어 번역본)
            const matesData = [
                { id: 1, name: "🇨🇦 Abby", languages: ["영어", "한국어"], style: ["맛집 탐방", "여유로운"], interests: ["커피", "산책", "현지 음식"], status: "Active", statusClass: "status_active", img: "./images/sub3/findamate1.png", availability: "평일" },
                ...
                { id: 4, name: "🇪🇸 Carlos", languages: ["스페인어", "영어"], style: ["맛집 탐방", "산책"], interests: ["커피", "산책", "현지 음식"], status: "Offline", statusClass: "status_offline", img: "./images/sub3/findamate4.png", availability: "언제나" },
                ...
                { id: 7, name: "🇻🇳 Minh", languages: ["베트남어", "한국어"], style: ["맛집 탐방", "로컬 라이프"], interests: ["현지 음식", "쇼핑", "커피"], status: "Away", statusClass: "status_active", img: "./images/sub3/findamate7.png", availability: "언제나" },
                ...
                { id: 10, name: "🇮🇹 Luca", languages: ["이탈리아어", "영어"], style: ["맛집 탐방", "럭셔리"], interests: ["커피", "현지 음식", "전시 관람"], status: "Active", statusClass: "status_active", img: "./images/sub3/findamate10.png", availability: "평일" },
                ...
                { id: 12, name: "🇰🇷 Jun", languages: ["한국어", "영어"], style: ["로컬 라이프", "역사 탐방"], interests: ["산책", "사진 촬영", "현지 음식"], status: "Away", statusClass: "status_away", img: "./images/sub3/findamate12.png", availability: "주말" },
                { id: 13, name: "🇯🇵 Kenji", languages: ["일본어", "영어"], style: ["문화 탐방", "맛집 탐방"], interests: ["전시 관람", "현지 음식", "등산"], status: "Active", statusClass: "status_active", img: "./images/sub3/findamate13.png", availability: "평일" },
                ...
                { id: 18, name: "🇲🇽 Maria", languages: ["스페인어", "영어"], style: ["맛집 탐방", "나이트라이프"], interests: ["현지 음식", "펍 & 바", "산책"], status: "Active", statusClass: "status_active", img: "./images/sub3/findamate18.png", availability: "언제나" },
                ...
                { id: 21, name: "🇪🇬 Omar", languages: ["아랍어", "영어"], style: ["로컬 라이프", "맛집 탐방"], interests: ["현지 음식", "커피", "일몰"], status: "Active", statusClass: "status_active", img: "./images/sub3/findamate21.png", availability: "언제나" },
                ...
                { id: 26, name: "🇵🇭 Joy", languages: ["영어"], style: ["맛집 탐방", "액티비티"], interests: ["현지 음식", "바다", "산책"], status: "Active", statusClass: "status_active", img: "./images/sub3/findamate26.png", availability: "언제나" },
                ...
                { id: 29, name: "🇨🇱 Diego", languages: ["스페인어", "영어"], style: ["모험", "로컬 라이프"], interests: ["등산", "현지 음식", "일몰"], status: "Active", statusClass: "status_active", img: "./images/sub3/findamate29.png", availability: "평일" },
