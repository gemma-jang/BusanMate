AOS.init();
        ...
        // 5. Mate Stories Logic (한글 번역 데이터에 icon 속성 추가)
        const storiesData = [
            {
                img: "./images/main/mate_stories_photo1.png", 
                icon: "./images/main/user1.png",
                name: "Sarah",
        ...
        function changeMateStory(index) {
            ...
            const iconElement = document.getElementById('mate-name-icon'); // 아이콘 업데이트를 위한 요소
            ...
            setTimeout(() => {
                ...
                if (iconElement) {
                    ...
                    iconElement.onerror = function() { this.src = `https://placehold.co/40x40/ccc/fff?text=${data.name.charAt(0)}`; };
                }
